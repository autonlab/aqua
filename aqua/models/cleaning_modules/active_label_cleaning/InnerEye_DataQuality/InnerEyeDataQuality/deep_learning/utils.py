...
# from aqua.models.modules.active_label_cleaning.InnerEye_DataQuality.default_paths import PROJECT_ROOT_DIR
...
from aqua.models.cleaning_modules.active_label_cleaning.InnerEye_DataQuality.InnerEyeDataQuality.configs import model_config
from aqua.models.cleaning_modules.active_label_cleaning.InnerEye_DataQuality.InnerEyeDataQuality.configs.selector_config import get_default_selector_config
from aqua.models.cleaning_modules.active_label_cleaning.InnerEye_DataQuality.InnerEyeDataQuality.deep_learning.self_supervised.configs import ssl_model_config
from aqua.models.cleaning_modules.active_label_cleaning.InnerEye_DataQuality.InnerEyeDataQuality.deep_learning.self_supervised.utils import create_ssl_image_classifier
from aqua.models.cleaning_modules.active_label_cleaning.InnerEye_DataQuality.InnerEyeDataQuality.utils.generic import setup_cudnn, get_train_output_dir
...
def create_model(config: ConfigNode, model_id: Optional[int]) -> torch.nn.Module:
    ...
    if config.train.use_self_supervision:
        ...
        try:
            module = import_module('aqua.models.modules.active_label_cleaning.InnerEye_DataQuality.PyTorchImageClassification.models'f'.{config.model.type}.{config.model.name}')
        except ModuleNotFoundError:
            module = import_module(
                f'aqua.models.modules.active_label_cleaning.InnerEye_DataQuality.InnerEyeDataQuality.deep_learning.architectures.{config.model.type}.{config.model.name}')
