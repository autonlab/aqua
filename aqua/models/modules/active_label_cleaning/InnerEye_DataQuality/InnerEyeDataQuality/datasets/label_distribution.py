...
class LabelDistribution(object):
    ...
    def add_noise_to_distribution(self, offset: float, distribution: np.ndarray, noise_model_type: str) -> np.ndarray:
        from aqua.models.modules.active_label_cleaning.InnerEye_DataQuality.InnerEyeDataQuality.datasets.label_noise_model import get_cifar10_asym_noise_model
        from aqua.models.modules.active_label_cleaning.InnerEye_DataQuality.InnerEyeDataQuality.datasets.label_noise_model import get_cifar10_sym_noise_model
